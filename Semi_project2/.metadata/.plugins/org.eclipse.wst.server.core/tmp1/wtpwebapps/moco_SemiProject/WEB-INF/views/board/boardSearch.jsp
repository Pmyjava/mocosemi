        ...
        <table class="table" id="BoardListT">
            <tr style="height: 50px;">
                <td colspan="6">
                    ...
                    <input id = "boardAnonymity" type="checkbox" value="Y">
                    </c:if>
                    <c:if test="${ boardCategory ne 'FREE' }">
                    <input id = "boardAnonymity" type="hidden" value="N">
                    </c:if>
                </td>
            </tr>
            <tr>
        	...
        	<!-- 이전페이지 -->
	            <li class="page-item">
	            	...
	            	<c:if test="${pi.currentPage>1 }">
	            			...
	            			<c:if test="${ boardCategory == FREE }">
	            			<c:param name="boardCategory" value="${boardAnonymity }"></c:param>
	            			</c:if>
