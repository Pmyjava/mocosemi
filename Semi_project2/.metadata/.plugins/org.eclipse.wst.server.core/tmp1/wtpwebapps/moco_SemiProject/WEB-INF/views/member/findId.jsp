...
<body>
    ...
    <h4 style="text-align: center;">아이디가 기억나지 않으세요? 가입 이메일을 이용해서 아이디를 확인하실수 있습니다.</h4>
    ...
    <form action="">
        <div id="searchIdBox">
            <table style="margin: auto;" id="member">
                <tr>
                    <td><label for="userId">이름</label>
                </tr>
                <tr>
                    <td><input type="text" class="findId" name="userName" id="userName"></td>
                </tr>
                <tr>
