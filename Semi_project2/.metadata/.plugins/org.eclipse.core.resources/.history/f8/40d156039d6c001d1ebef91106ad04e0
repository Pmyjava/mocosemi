		...
		<fieldset>
				...
				<table>
					...
					<tr>
						...
						<tr>
						<td>전화번호*:</td>
						<td><input type="text" style="width:300px; height:30px;" name="infoPhone" required></td>
						<td>주소*:</td>
						<td><input type="text" id="address_kakao" style="width:300px; height:30px;" name="infoAddress" readonly /></td>	
					</tr>
						<tr>
						<td>총 비용*:</td>
						<td><input type="text" style="width:300px; height:30px;" name="infoPrice" required></td>
						<td>온/오프라인*:</td>
						<td>
					...
					<tr>
						<td>선발 절차*:</td>
						<td colspan="4"><input type="text" style="width:750px; height:30px;" name="infoDetail" required ></td>
					</tr>
					<tr>
				...
				<textarea id="summernote" name="infoAddInfomation"></textarea>
