...
/* 	    border-width: 1px 0; */
	...
	button {font-size: 5px; color: #252525;}
		    	...
		    	<table>
		    		...
		    		<thead id="thead">
		    			<tr>
		    				...
		    				<th><div class="tb-center">신고일자</div>
		    				<th><div class="tb-center">신고자</div>
		    		...
		    		<tbody>
		    			<tr>
		    				...
		    				<td><div class="tb-center"><button type="submit">Y</button><button type="submit">N</button></div></td>
		    			</tr>
		    			<tr>
		    				<td><div class="tb-center">후기게시판</div></td>
		    				<td><div class="tb-left"><a href="">KH 정보교육원 자바 스프링반 솔직 후기 (1)</a></div></td>
